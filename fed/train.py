...
from utils.utils_fit import fit_one_epoch1yolo
...
if __name__ == "__main__":
    ...
    #------------------------------------------------------#
    train_annotation_path   = 'client_data/test_train.txt'
    val_annotation_path     = 'client_data/test_val.txt'
    ...
    if True:
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            fit_one_epoch1yolo(model_train, model, ema, yolo_loss, loss_history, eval_callback, optimizer, epoch, epoch_step, epoch_step_val, gen, gen_val, UnFreeze_Epoch, Cuda, fp16, scaler, save_period, save_dir, local_rank)
